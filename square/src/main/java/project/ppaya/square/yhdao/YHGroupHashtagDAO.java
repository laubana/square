...
public class YHGroupHashtagDAO
{
	...
	public ArrayList<Integer> getGroupIdByHashtagGroupCategoryId(String hashtag, int group_category_id)
	{
		...
		try
		{
			group_id_list = mapper.getGroupIdByHashtagGroupCategoryId(map);
		}
