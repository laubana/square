...
import project.ppaya.square.yhmapper.EventScheduleImageMapper;
import project.ppaya.square.yhvo.EventScheduleImage;

@Repository
public class EventScheduleImageDAO
{
	@Autowired
			...
			)
	{
		...
		EventScheduleImageMapper mapper = sqlSession.getMapper(EventScheduleImageMapper.class);
