...
<html>
  ...
  <body>
    ...
    <button id="test_button" style="display: block;">Sign Out</button>
	...
	function test1()
	{
		...
		else
		{
			...
			gapi.auth2.getAuthInstance().isSignedIn.listen(test2);
		}
	}
	function test2()
	{
      ...
      function listUpcomingEvents() {
        gapi.client.calendar.events.list({
          ...
          'orderBy': 'startTime'
        	...
        	{
        		console.log(response.result.items[i].start.dateTime + " ~ " + response.result.items[i].end.dateTime);
        	}
