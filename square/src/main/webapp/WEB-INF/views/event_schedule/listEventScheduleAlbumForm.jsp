	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						<h1><a href="viewEventScheduleForm?group_category=${group_category.group_category_id}&group_id=${group.group_id}&event_id=${event.event_id}&event_schedule_id=${event_schedule.event_schedule_id}"><strong>${group.name}の${event.name}の${event_schedule.name}</strong> アルバム</a></h1>
						<nav>
							<ul>
