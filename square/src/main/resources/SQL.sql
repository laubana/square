...
INSERT INTO TABLE_U(USER_ID, PASSWORD, NAME, IMAGE_ID, REGION, CONTENT) VALUES('id1', 'password', 'name1', 'image.jpg', '광주', 'id1content');
INSERT INTO TABLE_U(USER_ID, PASSWORD, NAME, REGION, CONTENT) VALUES('id2', 'password', 'name2', '광주', 'id2content');
...
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(2, 1, 'id1', 'group1boardcontent2', 1554685200000);
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(3, 1, 'id1', 'group1boardcontent3', 1554688800000);
...
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(5, 1, 'id1', 'group1boardcontent5', 1554696000000);
