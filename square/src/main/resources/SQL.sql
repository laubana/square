...
INSERT INTO TABLE_U(USER_ID, PASSWORD, NAME, IMAGE_ID, REGION, CONTENT) VALUES('id1', 'password', 'name1', 'id1.jpg', '광주', 'id1content');
INSERT INTO TABLE_U(USER_ID, PASSWORD, NAME, IMAGE_ID, REGION, CONTENT) VALUES('id2', 'password', 'name2', 'id2.jpg', '광주', 'id2content');
INSERT INTO TABLE_U(USER_ID, PASSWORD, NAME, IMAGE_ID, REGION, CONTENT) VALUES('id3', 'password', 'name3', 'id3.jpg', '광주', 'id3content');
INSERT INTO TABLE_U(USER_ID, PASSWORD, NAME, IMAGE_ID, REGION, CONTENT) VALUES('id4', 'password', 'name4', 'id4.jpg', '광주', 'id4content');
INSERT INTO TABLE_U(USER_ID, PASSWORD, NAME, IMAGE_ID, REGION, CONTENT) VALUES('id5', 'password', 'name5', 'id5.jpg', '광주', 'id5content');
INSERT INTO TABLE_U(USER_ID, PASSWORD, NAME, IMAGE_ID, REGION, CONTENT) VALUES('id6', 'password', 'name6', 'id6.jpg', '광주', 'id6content');
INSERT INTO TABLE_U(USER_ID, PASSWORD, NAME, IMAGE_ID, REGION, CONTENT) VALUES('id7', 'password', 'name7', 'id7.jpg', '광주', 'id7content');
INSERT INTO TABLE_U(USER_ID, PASSWORD, NAME, IMAGE_ID, REGION, CONTENT) VALUES('id8', 'password', 'name8', 'id8.jpg', '광주', 'id8content');
...
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(1, 1, 'id1', 'group1boardcontent1', 1554681600000);
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(2, 1, 'id3', 'group1boardcontent2', 1554685200000);
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(3, 1, 'id8', 'group1boardcontent3', 1554688800000);
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(4, 1, 'id1', 'group1boardcontent4', 1554692400000);
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(5, 1, 'id3', 'group1boardcontent5', 1554696000000);
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(6, 2, 'id7', 'group2boardcontent1', 1554681600000);
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(7, 2, 'id2', 'group2boardcontent2', 1554685200000);
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(8, 2, 'id4', 'group2boardcontent3', 1554688800000);
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(9, 2, 'id2', 'group2boardcontent4', 1554692400000);
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(10, 2, 'id7', 'group2boardcontent5', 1554696000000);
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(11, 3, 'id2', 'group3boardcontent1', 1554681600000);
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(12, 3, 'id1', 'group3boardcontent2', 1554685200000);
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(13, 3, 'id5', 'group3boardcontent3', 1554688800000);
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(14, 3, 'id6', 'group3boardcontent4', 1554692400000);
INSERT INTO TABLE_GCO(GROUP_COMMENT_ID, GROUP_ID, USER_ID, CONTENT, INPUT_DATE) VALUES(15, 3, 'id1', 'group3boardcontent5', 1554696000000);
INSERT INTO TABLE_GA(USER_ID, GROUP_ID) VALUES('id1', 1);
INSERT INTO TABLE_GA(USER_ID, GROUP_ID) VALUES('id3', 1);
INSERT INTO TABLE_GA(USER_ID, GROUP_ID) VALUES('id8', 1);
INSERT INTO TABLE_GA(USER_ID, GROUP_ID) VALUES('id7', 2);
INSERT INTO TABLE_GA(USER_ID, GROUP_ID) VALUES('id2', 2);
INSERT INTO TABLE_GA(USER_ID, GROUP_ID) VALUES('id4', 2);
INSERT INTO TABLE_GA(USER_ID, GROUP_ID) VALUES('id2', 3);
INSERT INTO TABLE_GA(USER_ID, GROUP_ID) VALUES('id1', 3);
INSERT INTO TABLE_GA(USER_ID, GROUP_ID) VALUES('id5', 3);
INSERT INTO TABLE_GA(USER_ID, GROUP_ID) VALUES('id6', 3);
INSERT INTO TABLE_E(EVENT_ID, NAME, CONTENT, GROUP_ID, USER_ID) VALUES(1, 'group1event1', 'group1event1content', 1, 'id1');
INSERT INTO TABLE_E(EVENT_ID, NAME, CONTENT, GROUP_ID, USER_ID) VALUES(2, 'group1event2', 'group1event2content', 1, 'id3');
INSERT INTO TABLE_E(EVENT_ID, NAME, CONTENT, GROUP_ID, USER_ID) VALUES(3, 'group1event3', 'group1event3content', 1, 'id8');
INSERT INTO TABLE_E(EVENT_ID, NAME, CONTENT, GROUP_ID, USER_ID) VALUES(4, 'group2event1', 'group2event1content', 2, 'id7');
INSERT INTO TABLE_E(EVENT_ID, NAME, CONTENT, GROUP_ID, USER_ID) VALUES(5, 'group2event2', 'group2event2content', 2, 'id2');
INSERT INTO TABLE_E(EVENT_ID, NAME, CONTENT, GROUP_ID, USER_ID) VALUES(6, 'group2event3', 'group2event3content', 2, 'id4');
INSERT INTO TABLE_E(EVENT_ID, NAME, CONTENT, GROUP_ID, USER_ID) VALUES(7, 'group3event1', 'group3event1content', 3, 'id6');
INSERT INTO TABLE_E(EVENT_ID, NAME, CONTENT, GROUP_ID, USER_ID) VALUES(8, 'group3event2', 'group3event2content', 3, 'id5');
...
INSERT INTO TABLE_ESV(EVENT_SCHEDULE_VIDEO_ID, FILENAME, EXT, USER_ID, EVENT_SCHEDULE_ID) VALUES('3a9c7198af', '3a9c7198af.mp4', 'mp4', 'id1', 1);
...
INSERT INTO TABLE_ESUS(USER_SCHEDULE_ID, USER_ID, EVENT_SCHEDULE_ID, START_DATE, END_DATE) VALUES(1, 'id1', 1, 1554681600000, 1554692400000);
INSERT INTO TABLE_ESUS(USER_SCHEDULE_ID, USER_ID, EVENT_SCHEDULE_ID, START_DATE, END_DATE) VALUES(2, 'id1', 1, 1554696000000, 1554724800000);
INSERT INTO TABLE_ESUS(USER_SCHEDULE_ID, USER_ID, EVENT_SCHEDULE_ID, START_DATE, END_DATE) VALUES(3, 'id1', 1, 1554681600000, 1554685200000);
INSERT INTO TABLE_ESUS(USER_SCHEDULE_ID, USER_ID, EVENT_SCHEDULE_ID, START_DATE, END_DATE) VALUES(4, 'id1', 1, 1554724800000, 1554728400000);
INSERT INTO TABLE_UH(HASHTAG, USER_ID) VALUES('id1hashtag1', 'id1');
INSERT INTO TABLE_UH(HASHTAG, USER_ID) VALUES('id1hashtag2', 'id1');
INSERT INTO TABLE_UH(HASHTAG, USER_ID) VALUES('id2hashtag1', 'id2');
INSERT INTO TABLE_UH(HASHTAG, USER_ID) VALUES('id2hashtag2', 'id2');
INSERT INTO TABLE_GH(HASHTAG, GROUP_ID) VALUES('group1hashtag1', 1);
INSERT INTO TABLE_GH(HASHTAG, GROUP_ID) VALUES('group1hashtag2', 1);
COMMIT;