...
(
	...
	EVENT_ID NUMBER NOT NULL,
	INPUT_DATE NUMBER DEFAULT (CAST(SYSTIMESTAMP AS DATE) - DATE '1970-01-01')*24*60*60*1000 + MOD( EXTRACT( SECOND FROM SYSTIMESTAMP ), 1 ) * 1000 - 32400000,
	CONSTRAINT ES_GI_FK FOREIGN KEY(GROUP_ID) REFERENCES TABLE_E(GROUP_ID),
...
INSERT INTO TABLE_ES(EVENT_SCHEDULE_ID, NAME, CONTENT, GROUP_ID, EVENT_ID, REGION, LATITUDE, LONGITUDE) VALUES(19, '3番目のMeeting', 'event1_event_schedule3content', 1,'大阪市 大正区', '35.6685256','139.7679124');
INSERT INTO TABLE_ES(EVENT_SCHEDULE_ID, NAME, CONTENT, GROUP_ID, EVENT_ID, REGION, LATITUDE, LONGITUDE) VALUES(20, '4番目のMeeting', 'event1_event_schedule4content', 1,'仙台市　宮城県', '35.67016907' ,'76203390000004');
INSERT INTO TABLE_ES(EVENT_SCHEDULE_ID, NAME, CONTENT, GROUP_ID, EVENT_ID, REGION, LATITUDE, LONGITUDE) VALUES(21, '5番目のMeeting', 'event1_event_schedule5content', 1,'名古屋　愛知県', '35.67002907', '139.7685339000003');
INSERT INTO TABLE_ES(EVENT_SCHEDULE_ID, NAME, CONTENT, GROUP_ID, EVENT_ID, REGION, LATITUDE, LONGITUDE) VALUES(22, '6番目のMeeting', 'event1_event_schedule6content', 1,'東京都中央区京橋','35.67106907' ,'139.762133900004');
INSERT INTO TABLE_ES(EVENT_SCHEDULE_ID, NAME, CONTENT, GROUP_ID, EVENT_ID, REGION, LATITUDE, LONGITUDE) VALUES(23, '7番目のMeeting', 'event1_event_schedule7content', 1,' 東京都千代田区日比谷公園','35.6759907','139.7707339000004');
INSERT INTO TABLE_ES(EVENT_SCHEDULE_ID, NAME, CONTENT, GROUP_ID, EVENT_ID, REGION, LATITUDE, LONGITUDE) VALUES(24, '8番目のMeeting', 'event1_event_schedule8content', 1,'東京都中央区八重洲','35.6766907','77013380004');
INSERT INTO TABLE_ES(EVENT_SCHEDULE_ID, NAME, CONTENT, GROUP_ID, EVENT_ID, REGION, LATITUDE, LONGITUDE) VALUES(25, '9番目のMeeting', 'event1_event_schedule9content', 1,'東京','35.67556907','139.7699033257');
INSERT INTO TABLE_ES(EVENT_SCHEDULE_ID, NAME, CONTENT, GROUP_ID, EVENT_ID, REGION, LATITUDE, LONGITUDE) VALUES(26, '10番目のMeeting', 'event1_event_schedule10content', 1,'東京','35.67606907','139.77113941000004');
INSERT INTO TABLE_ES(EVENT_SCHEDULE_ID, NAME, CONTENT, GROUP_ID, EVENT_ID, REGION, LATITUDE, LONGITUDE) VALUES(27, '11番目のMeeting', 'event1_event_schedule11content', 1,'東京','35.67506907','139.77044100004');
INSERT INTO TABLE_ES(EVENT_SCHEDULE_ID, NAME, CONTENT, GROUP_ID, EVENT_ID, REGION, LATITUDE, LONGITUDE) VALUES(28, '12番目のMeeting', 'event1_event_schedule12content', 1,'東京','35.67526907','139.76835000004');
INSERT INTO TABLE_ES(EVENT_SCHEDULE_ID, NAME, CONTENT, GROUP_ID, EVENT_ID, REGION, LATITUDE, LONGITUDE) VALUES(29, '13番目のMeeting', 'event1_event_schedule13content', 1,'東京','35.6681907','139.7601033333004');
INSERT INTO TABLE_ES(EVENT_SCHEDULE_ID, NAME, CONTENT, GROUP_ID, EVENT_ID, REGION, LATITUDE, LONGITUDE) VALUES(30, '14番目のMeeting', 'event1_event_schedule14content', 1,'東京','35.66726907','139.7598539004');
INSERT INTO TABLE_ES(EVENT_SCHEDULE_ID, NAME, CONTENT, GROUP_ID, EVENT_ID, REGION, LATITUDE, LONGITUDE) VALUES(31, '15番目のMeeting', 'event1_event_schedule15content', 1,'東京','35.66956907','139.76103390000004');
INSERT INTO TABLE_ES(EVENT_SCHEDULE_ID, NAME, CONTENT, GROUP_ID, EVENT_ID, REGION, LATITUDE, LONGITUDE) VALUES(32, '16番目のMeeting', 'event1_event_schedule16content', 1,'東京','35.66676907','139.757390000004');
