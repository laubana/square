...
(
	EVENT_SCHEDULE_IMAGE_ID VARCHAR2(100) PRIMARY KEY,
...
(
	EVENT_SCHEDULE_IMAGE_FACE_ID VARCHAR2(100) PRIMARY KEY,
	TOP NUMBER NOT NULL,
	LEFT NUMBER NOT NULL,
	WIDTH NUMBER NOT NULL,
	HEIGHT NUMBER NOT NULL,
	EVENT_SCHEDULE_IMAGE_ID VARCHAR2(100) NOT NULL,
...
INSERT INTO TABLE_GC(GROUP_CATEGORY_ID, NAME) VALUES(GC_SEQ.NEXTVAL, '게임');
INSERT INTO TABLE_G(GROUP_ID, GROUP_CATEGORY_ID, REGION, USER_ID, NAME, CONTENT) VALUES(G_SEQ.NEXTVAL, 1, '광주', 'id1', 'group1', 'group1content');
INSERT INTO TABLE_G(GROUP_ID, GROUP_CATEGORY_ID, REGION, USER_ID, NAME, CONTENT) VALUES(G_SEQ.NEXTVAL, 1, '광주', 'id2', 'group2', 'group2content');
INSERT INTO TABLE_G(GROUP_ID, GROUP_CATEGORY_ID, REGION, USER_ID, NAME, CONTENT) VALUES(G_SEQ.NEXTVAL, 1, '광주', 'id1', 'group3', 'group3content');
...
INSERT INTO TABLE_E(EVENT_ID, NAME, CONTENT, GROUP_ID, USER_ID) VALUES(E_SEQ.NEXTVAL, 'event1', 'event1content', 1, 'id1');
INSERT INTO TABLE_E(EVENT_ID, NAME, CONTENT, GROUP_ID, USER_ID) VALUES(E_SEQ.NEXTVAL, 'event2', 'event2content', 2, 'id2');
INSERT INTO TABLE_ES(EVENT_SCHEDULE_ID, TITLE, PLACE, START_DATE, END_DATE, EVENT_ID) VALUES(ES_SEQ.NEXTVAL, 'event_schedule1', '광주', 0, 0, 1);
INSERT INTO TABLE_ES(EVENT_SCHEDULE_ID, TITLE, PLACE, START_DATE, END_DATE, EVENT_ID) VALUES(ES_SEQ.NEXTVAL, 'event_schedule2', '광주', 0, 0, 2);
